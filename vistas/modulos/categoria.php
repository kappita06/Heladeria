                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light shadow p-lg-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            <a href="categoria.php" class="nav-item nav-link active">Categoria</a>
                        </div>
                ...
                <div class="col-12 text-center">
                    <ul class="list-inline mb-4 pb-2" id="portfolio-flters">
                        ...
                        foreach ($categorias as $key => $categoria) {
                            // Para usar en data-filter, eliminamos espacios y lo dejamos en minúscula
                            $nombreClase = strtolower(str_replace(' ', '', $categoria["nombre"]));

                            echo '<li class="btn btn-sm btn-outline-primary m-1" data-filter=".' . $nombreClase . '">' . $categoria["nombre"] . '</li>';
                        }
                        ?>
                    </ul>
                </div>
                ...
                <div class="col-12 mt-2 mb-4">
                    <div class="row">
                        <div class="col-sm-6 text-center text-sm-right border-right mb-3 mb-sm-0">
                            ...
                            <p class="mb-2">Jr.Juan Velazco 515</p>
                            <p class="mb-0">+51 123 456 789</p>
                        </div>
                        <div class="col-sm-6 text-center text-sm-left">
                            <h5 class="font-weight-bold mb-2">Horarios</h5>
                            <p class="mb-2">Martes – Domingo, 10AM – 7PM</p>
                            <p class="mb-0">Lunes: Cerrado</p>
                        </div>
                    </div>
                </div>
                <div class="col-12">
